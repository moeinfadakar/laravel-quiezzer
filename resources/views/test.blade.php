...
<div class="row mt-4">
    <div class="row d-flex justify-content-center align-items-center mb-5 text-center">
        <h3 class="text-dark">{{ $question->name  }}</h3>
    </div>
...
<div class="col-4 d-flex justify-content-end align-items-center "> <div class="progress" dir="ltr" style="width:{{ Session::get("allme") }}rem">
        <div dir="ltr" class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100" style="width: {{ $question->id  }}rem  "></div>
    </div></div>
...
<div class="row-3 mx-auto d-flex justify-content-center align-content-center">
  <input type="radio" class="btn-check " name="userAnswer" value="{{  $Answer->id }}" id="option{{ $Answer->id }}" >
<label class="btn " for="option{{$Answer->id}}">
    {{ $Answer->text }}</label>
